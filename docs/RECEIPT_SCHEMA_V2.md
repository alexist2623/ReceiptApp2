...
`SUBTOTAL_PRICE`, `TAX_NAME`, `TAX_RATE`, `TAX_PRICE`, `DISCOUNT_PRICE`,
`SERVICE_PRICE`, `TOTAL_PRICE`, `CASH_PRICE`, `CHANGE_PRICE`, `CARD_PRICE`,
`TIP_PRICE`, `PAYMENT_METHOD`, `PAYMENT_CARD`, `PAYMENT_AUTH_CODE`,
`PAYMENT_INFO`, `APPROVAL_CODE`, `TRANSACTION_ID`
